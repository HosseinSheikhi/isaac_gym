...
class KinovaCameraIKEnv(BaseTask):
    ...
    def reset(self, env_ids):
        """
            ...
            3- to set the goal the kinova has to MOVE to a random conf and capture a rgb as goal and then get back to the home and take another rgb as current obs
    ...
    def pre_physics_step(self, actions):
        ...
        if(len(kinova_indices)>0):
            ...
            targets =  dof_pos.squeeze(-1) + u.squeeze(-1)
